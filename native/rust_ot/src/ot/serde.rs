use super::{Operation, OperationSeq};
use serde::{
...
impl Serialize for Operation {
    ...
    S: Serializer,
  {
    match self {
      ...
      Operation::Insert(s) => serializer.serialize_str(&String::from_utf16_lossy(s)),
    }
  }
}
    ...
    D: Deserializer<'de>,
  {
    ...
    impl<'de> Visitor<'de> for OperationVisitor {
      ...
      where
        E: de::Error,
      {
        Ok(Operation::Insert(value.to_owned().encode_utf16().collect()))
      }
    }
